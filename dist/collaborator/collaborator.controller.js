...
let CollaboratorController = class CollaboratorController {
    collaboratorServivce;
    constructor(collaboratorServivce) {
        this.collaboratorServivce = collaboratorServivce;
    }
...
__decorate([
    (0, common_2.Post)('/addCollaborator'),
...
exports.CollaboratorController = CollaboratorController = __decorate([
    (0, common_1.Controller)('api/collaborator'),
